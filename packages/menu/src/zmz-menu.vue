<template>
	<ul class="zmz-menu"  :class="{ 'zmz-menu--horizontal': mode == 'horizontal', 'zmz-menu--vertical': mode == 'vertical' }" :style="{ 'background-color': backgroundColor }">
		<slot></slot>
	</ul>
</template>
...
<script>
  ...
  import Menubar from '../../public/aria-menubar';
  export default {
    name: 'ZmzMenu',
    ...
    watch: {
      ...
      collapse(value) {
        ...
        this.broadcast('ZmzSubmenu', 'toggle-collapse', value);
      }
    },
    methods: {
