...
<div class="demo-block">
  <zmz-row>
    <zmz-col :span="4">
      <zmz-skeleton></zmz-skeleton>
    </zmz-col>
    <zmz-col :span="4" class="zmz-ml-10">
      <zmz-row>
        <zmz-col :span="12" class="zmz-mb-20">
          <zmz-skeleton :proportion="0.2"></zmz-skeleton>
        </zmz-col>
        <zmz-col :span="24" class="zmz-mb-20">
          <zmz-skeleton :proportion="0.1"></zmz-skeleton>
        </zmz-col>
        <zmz-col :span="24" class="zmz-mb-20">
          <zmz-skeleton :proportion="0.1"></zmz-skeleton>
        </zmz-col>                  
...
<template>
  <div class="main-skeleton">
    <zmz-skeleton height="80px"></zmz-skeleton>
    <div>
      <div class="skeleton-container">
        <div class="skeleton">
          <zmz-skeleton height="300px"></zmz-skeleton>
        </div>
        <zmz-skeleton height="45px"></zmz-skeleton>
      </div>
